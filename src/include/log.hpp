...
#define debug_log(...)      print_log(DEBUG_LOG, __VA_ARGS__)
#define info_log(...)       print_log(INFO_LOG, __VA_ARGS__)
#define warning_log(...)    print_log(WARNING_LOG, __VA_ARGS__)
#define error_log(...)      print_log(ERROR_LOG, __VA_ARGS__)
